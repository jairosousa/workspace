...
public class StreamExample {
      ...
      private List<String> words = Arrays.asList("foo", "bar", "home", "sword", "play", "animal", "sword", "car", "sun",
                  "java");
      ...
      void operations() {
            ...
            List.of("1", "2", "3", "4", "5", "6", "7").parallelStream()
                        .map(s -> {
                              System.out.println(
                                          "Map     " + s + " value in thread: " + Thread.currentThread().getName());
                              return s;
                        })
                        .forEach(s -> System.out
                                    .println("Foreach " + s + " value in thread: " + Thread.currentThread().getName()));
      }
