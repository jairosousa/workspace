package br.com.jnsdevs.reativedockercompose;

import br.com.jnsdevs.reativedockercompose.book.Book;
import br.com.jnsdevs.reativedockercompose.book.BookRepository;
...
public class ReativeDockerComposeApplication {

	public static void main(String[] args) {
		SpringApplication.run(ReativeDockerComposeApplication.class, args);
	}
